...
import uk.co.jacekk.bukkit.infiniteplots.command.SetTimeCommandExecutor;
import uk.co.jacekk.bukkit.infiniteplots.command.SetWeatherCommandExecutor;
...
public class InfinitePlots extends BasePlugin {
	...
	private Economy economy;
        ...
        public ArrayList <String> isInside = new ArrayList<String>();
	...
	public void onEnable(){
		...
		if (!this.config.getBoolean(Config.GENERATOR_ONLY)){
			...
			this.commandManager.registerCommandExecutor(new SetTimeCommandExecutor(this));
			this.commandManager.registerCommandExecutor(new SetWeatherCommandExecutor(this));
