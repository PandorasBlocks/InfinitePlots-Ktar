...
public class Config {
	...
	public static final PluginConfigKey BLOCKS_PATH				= new PluginConfigKey("blocks.path",			44);
	public static final PluginConfigKey BLOCKS_PATH_DATA                    = new PluginConfigKey("blocks.path-data", 		0);
	public static final PluginConfigKey BLOCKS_LOWER_WALL                   = new PluginConfigKey("blocks.lower-wall",		98);
