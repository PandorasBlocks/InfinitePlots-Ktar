...
public class InfoCommandExecutor extends BaseCommandExecutor<InfinitePlots> {
	...
	public void plotInfo(CommandSender sender, String label, String[] args){
		...
		player.sendMessage(ChatColor.BLUE + "Name: " + ChatColor.RESET + plot.getName());
                player.sendMessage(ChatColor.BLUE + "Time: " + ChatColor.RESET + plot.getTime().toString());
                
                if(plot.getWeather() == true){
                    player.sendMessage(ChatColor.BLUE + "Weather: " + ChatColor.RESET + "Sunny");
                }else if(plot.getWeather() == false){
                    player.sendMessage(ChatColor.BLUE + "Weather: " + ChatColor.RESET + "Rainy");
                }
