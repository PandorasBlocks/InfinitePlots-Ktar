...
public class PlotConfig {
	...
	public static final PluginConfigKey INFO_WEATHER		= new PluginConfigKey("info.isSunny",			true);
	public static final PluginConfigKey INFO_TIME			= new PluginConfigKey("info.time",                      0L);
