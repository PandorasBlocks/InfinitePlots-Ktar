		...
		for (int cx = 0; cx < 16; ++cx){
			for (int cz = 0; cz < 16; ++cz){
				...
				if (x % this.size == 0 && z % this.size == 0){
					...
					world.getBlockAt(x + 1, y, z).setTypeIdAndData(44, data, false);
					world.getBlockAt(x - 1, y, z).setTypeIdAndData(44, data, false);
					world.getBlockAt(x, y, z + 1).setTypeIdAndData(44, data, false);
					world.getBlockAt(x, y, z - 1).setTypeIdAndData(44, data, false);
					
					world.getBlockAt(x + 1, y, z + 1).setTypeIdAndData(44, data, false);
					world.getBlockAt(x + 1, y, z - 1).setTypeIdAndData(44, data, false);
					world.getBlockAt(x - 1, y, z + 1).setTypeIdAndData(44, data, false);
					world.getBlockAt(x - 1, y, z - 1).setTypeIdAndData(44, data, false);
